...
def _run_cli() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help", "-?"):
        ...
        print("  connectors <path>       scan a project with the full-stack connectors (cross-layer + message queues) and print a JSON report")
        print("    --language <lang>       track only this language (e.g. python; default: all)")
        print("    --all                   also scan GraphQL, gRPC, message queues, cloud (terraform/compose/k8s/code)")
